...
const GATES = {
  ...
  'onboarding-first-run':     { applies_when: ['content_source=user-created'], provides: ['first run'] },
  'initial-content-bootstrap':{ applies_when: ['content_source!=user-created'], provides: ['day-one content'] },
  'landing-composition':      { applies_when: ['distribution=public'], provides: ['acquisition surface'] },
  'ship-ready-audit':         { applies_when: ['distribution=public'], provides: ['launch surface'] },
  'legal-and-consent':        { applies_when: ['distribution=public', 'collects_personal_data=true'], provides: ['consent record'] },
